...
test('init envelope carries config and params', () => {
  const env: WorkerEnvelope = {
    kind: 'init',
    config: { DELIVEROO_HOST: 'h', DELIVEROO_PORT: 1, TOKEN_LIAISON: 'a', TOKEN_COURIER: 'b', OPENAI_MODEL: 'm', OPENAI_API_KEY: 'k', OPENAI_BASE_URL: '', LOG_LEVEL: 'info', LOG_DIR: './logs', MISSION_HANDLER: 'OFF' },
